...
- Repository editor and six AI provider adapters with scoped conversations
...
passed for Codex, Claude, Grok, OpenCode, and ModelArk; Gemini still requires its
remaining authenticated acceptance checks. ModelArk is a read-only streamed-chat
provider; see [[ModelArk Provider]].
